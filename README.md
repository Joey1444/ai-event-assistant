...
> AI 提议 · 人类拍板 —— 一条可定制的 AI 活动策划流水线

小莫用「**AI 提议 + 人类决定**」的方式，把一次活动从需求分析一路推进到最终审批：你填一份简报，11 个 AI 智能体分工完成方案、预算、文案、海报与质检，两道关键审批由你亲手点击。它不限于文化活动——调整提示词和字段，就能适配教学计划、项目申报等更多场景。首个落地示例：莫伊大学孔子学院 2026 年中秋节活动策划。
